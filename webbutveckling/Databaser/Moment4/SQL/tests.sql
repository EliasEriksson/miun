...
insert into userProfiles values (1, '123', 'doe', '', default, now());
insert into userProfiles values (1, 'john', '', '', default, now());
insert into userProfiles values (1, 'john', 'doe', '', 'path/to/file.png', now());
